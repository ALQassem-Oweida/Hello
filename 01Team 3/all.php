					...
					<div class="filter-content collapse show" id="collapse_3">
						<div class="card-body">
							<form action="./all.php" method="GET">
								...
								<button class="btn btn-block btn-lg btn-info">Apply</button>
							</form>
						</div><!-- card-body.// -->
					</div>
							...
							<figure class="card card-product-grid">
								...
								<figcaption class="info-wrap">
									<div class="fix-height">
										<center> <a href="test.php?id=<?php echo $row['product_id'] ?>" class="title"><?php echo $row["product_name"] ?></a></center>
